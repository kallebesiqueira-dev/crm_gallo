...
/**
 * Month view of tasks — the old standalone /calendar page, now a mode of the
 * Tasks screen (skills.md §4: Calendario merged into Attività). Read-only
 * grid + per-day side panel; task mutations live in the list view.
 */
