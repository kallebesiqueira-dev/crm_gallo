...
/**
 * Reports — the old standalone /reports page, now the "Report" tab of the
 * Performance screen (skills.md §4: both are analytics, one screen). Also
 * hosts the financial block that used to sit mid-dashboard.
 */
export function ReportsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Financial block — relocated from the dashboard (skills.md §4) */}
